...
namespace FMM\OryxBundle\Resources\templates;

use Guzzle\Parser\UriTemplate\UriTemplateInterface;

/**
* Hack the original UriTemplate class to provide adapted parsing for the Oryx uris
*/
class OryxUriTemplate implements UriTemplateInterface
{
	/**
